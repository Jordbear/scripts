...
plot = sns.barplot(x='sample', y='PERCENT_DUPLICATION', hue='box', units='sample', dodge=False, data=dfc)
...
plt.savefig('duplication-grouped_by_box.png', format='png', dpi=500, bbox_inches='tight')
