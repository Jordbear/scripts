...
sns.lineplot(x='GC', y='NORMALIZED_COVERAGE', hue='box', units='sample', estimator=None, data=dfc, ax=ax2)
ax2.set(xlim=(0, 100))
ax2.set(ylim=(0, 2))
...
plt.savefig('gc_bias-grouped_by_box.png', format='png', dpi=500, bbox_inches='tight')
