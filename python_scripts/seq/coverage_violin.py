...
sample = [i.replace('_001_coverage.tsv', '') for i in files]
print(sample)
print('')
...
def barplot(y, variable):
    ...
    ax = fig.add_subplot(1, 1, 1)
    plot = sns.violinplot(x='sample', y=y, cut=0, scale='count', data=dfc)
    ...
    plt.savefig(y+'_violin.png', format='png', dpi=500, bbox_inches='tight')
