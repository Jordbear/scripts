...
dfc.columns=["Transcript position (5'-3' %)", 'Normalised coverage', 'Sample']
print(dfc)
print('')



plot = sns.lineplot(x="Transcript position (5'-3' %)", y='Normalised coverage', hue='Sample', data=dfc)
...
plt.savefig("transcript_coverage.png", format='png', dpi=500, bbox_inches='tight')
