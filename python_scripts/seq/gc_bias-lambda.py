...
sns.lineplot(x='GC', y='NORMALIZED_COVERAGE', hue='condition', data=dfc, ax=ax2)
ax2.set(xlim=(0, 100))
ax2.set(ylim=(0, 3))
...
plt.savefig('gc_bias-library-averaged.png', format='png', dpi=500, bbox_inches='tight')
