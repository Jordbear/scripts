...
dfm.columns=["Transcript position (5'-3' %)", 'Normalised Coverage', 'Sample']
#print(dfm)
#print('')


plot = sns.lineplot(x="Transcript position (5'-3' %)", y='Normalised Coverage', hue='Sample', data=dfm)

plot.set(xlim=(0, 100))
plot.set(ylim=(0, None))
plot.axes.axhline(1, color='grey', ls='--')
plot.legend(loc='center right', bbox_to_anchor=(1.4, 0.5), framealpha=1)


plot.figure.savefig("5'-3'coverageV2.png", format='png', dpi=1000, bbox_inches='tight')
