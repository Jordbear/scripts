...
dfm.columns=['Insert Size (bp)', 'Proportion of Reads', 'Sample', 'Group']
print(dfm)
print('')


plot = sns.lineplot(x='Insert Size (bp)', y='Proportion of Reads', hue='Group', units='Sample', estimator=None, data=dfm)
sns.despine()
plot.set(xlim=(0, 405))
plot.set(ylim=(0, None))
plot.legend(loc='center right', bbox_to_anchor=(1.25, 0.5), framealpha=1)
plot.figure.savefig("insert_sizes_grouped.png", format='png', dpi=1000, bbox_inches='tight')
