...
for i in dfl:
    ...
    plot = sns.relplot(x='Date', y='λ (%) CpG', ci=None, col='a', hue='Date', col_wrap=(1), kind='scatter', linewidth=0.2, height=3, aspect=1.5, s=30, data=dfl[count])
    ...
    plt.savefig('piccy3.png', format='png', dpi=500, bbox_inches='tight')
    count+=1
